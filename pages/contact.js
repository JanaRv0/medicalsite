...
export default function Contact() {
  ...
  async function submitHandler(e) {
    ...
    setStatus(json.status === 'success' ? 'sent' : 'error');
  }
    ...
    <Layout>
      ...
      <div className="card">
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="form-field"><label>Phone (Optional)</label><input name="phone" type="tel" className="input" /></div>
          <div className="form-field"><label>Subject</label><input name="subject" className="input" required /></div>
        ...
        {status === 'sent' && <div className="small">Thank you! Your message has been received and will be reviewed by our team.</div>}
        {status === 'error' && <div className="small">Error sending message. Please try again.</div>}
      </div>
    </Layout>
  );
}
